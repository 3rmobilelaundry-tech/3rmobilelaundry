...
echo.
echo ==================================================
echo Starting User App in Web Browser...
echo ==================================================
echo.
...
if %ERRORLEVEL% NEQ 0 (
    ...
    echo Please run the following command manually inside the user-app folder:
...
echo.
echo [System] Ensuring navigation and animation deps are installed...
call npx expo install @react-navigation/bottom-tabs react-native-reanimated
if %ERRORLEVEL% NEQ 0 (
    echo.
    echo [Error] Failed to install navigation/animation dependencies automatically.
    echo Please run the following command manually inside the user-app folder:
    echo     npx expo install @react-navigation/bottom-tabs react-native-reanimated
    pause
    exit /b
)

echo.
echo [System] Launching User App...
