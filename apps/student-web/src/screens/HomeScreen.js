...
import { View, Text, StyleSheet, TouchableOpacity, Alert, Linking, Image, useWindowDimensions, Modal, TextInput, KeyboardAvoidingView, Platform, Pressable, AccessibilityInfo, findNodeHandle, ActivityIndicator, ScrollView } from 'react-native';
